...
{
    /// <summary>
    /// Class representing a test for HTTP Basic authentication.
    /// </summary>
    public class BasicAuthenticationTest : AuthenticationTest
    {
        ...
        public BasicAuthenticationTest(BrowserKind browserKind) 
            : base(browserKind)
        {
        }
        ...
        {
            string url = string.Format("http://{0}:{1}/api/auth/basic", TestWebAppHostName, TestWebAppPort);
